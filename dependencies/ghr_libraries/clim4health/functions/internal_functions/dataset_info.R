datasets_info <- list(
  "reanalysis-era5-land" = list(
    ...
    year = c(1950:format(Sys.Date(), "%Y")),
    month = c(1:12),
    day = c(1:31),
    time = c(0:23),#paste0(sprintf("%02d", 0:23), ":00")
    area = "N,W,S,E coordinates, latitudes from 90 to -90, longitudes -180 to 180"
  ),
  "reanalysis-era5-land-monthly-means" = list(
    product_type = c("monthly_averaged_reanalysis",
  ...
  "reanalysis-era5-single-levels" = list(
    ...
    variable = c("10m_u_component_of_wind",
                  ...
                  "zero_degree_level"),
    year = c(1940:format(Sys.Date(), "%Y")),
    month = c(1:12),
    day= 1:31,
    time = 0:23,
    area = "N,W,S,E coordinates, latitudes from 90 to -90, longitudes -180 to 180"
  ),
  "reanalysis-era5-single-levels-monthly-means" = list(
    product_type = c("monthly_averaged_reanalysis",
                      "monthly_averaged_reanalysis_by_hour_of_day",
  ...
  "seasonal-monthly-single-levels" = list(
    originating_centre = c("ecmwf","ukmo","meteo_france",
                           "dwd", "cmcc", "ncep", "jma", "eccc"),
    system = c("1", "2", "3", "4", "5", "6", "7", "8", "12", "13",
               "14", "15", "21", "35", "51", "600", "601", "602",
               "603"),
    variable = c("10m_u_component_of_wind",
                  "10m_v_component_of_wind",
                  "10m_wind_gust_since_previous_post_processing",
                  ...
                  "total_column_water_vapour",
                  "total_precipitation"),
    product_type = c("ensemble_mean",
                      "hindcast_climate_mean",
                      "monthly_mean",
                      "monthly_minimum",
                      "monthly_maximum",
                      "monthly_standard_deviation"),
    year = c(1981:format(Sys.Date(), "%Y")),
    month = c(1:12),
    leadtime_month = c(1:6),
    area = "N,W,S,E coordinates, latitudes from 90 to -90, longitudes -180 to 180"
  )
)
