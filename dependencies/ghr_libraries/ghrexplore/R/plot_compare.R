...
#' @title plot_compare
#' @description combines multiple plots based on specified variables and plot type 
#' @details this function takes any input arguments from ghrexplore::plot_combine()
#' and from ghrexplore::plot_multiple() to customize the plots and their organization
#' in a grid
...
#' @param var the name of the variables identifying the variables to be plotted. 
#' @param type character that specifies the types of variable in `var`. 
#' Possible values include 'cov' (covariate, default), 'counts' (case counts), 
#' and 'inc' (case incidence). If `type='inc'`, `pop` is required.
#' @param ... Additional arguments for plot_multiple and/or plot_combine
